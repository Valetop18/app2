...
import { msCalendarMonth, msPersonRaisedHand, msCloudUpload } from "@material-symbols-react-native/outlined-400";
...
export const CamaraDipu = () => {
  ...
  const [leyActual, setLeyActual] = useState({fecha: ""});
  const partidos = {
    id: 0,
    partido: "IND",
    id: 1,
        ...
        <>
          <View style={styles.informacion}>
            <View style={styles.containerHoy}>
              <MsIcon icon={msCalendarMonth} size={20} color={COLORS.greenM} />
              <Text style={styles.textHoy}>Hoy</Text>
            </View>
            <View style={styles.estadistica}>
              <View style={styles.estadistica2} width={105} height={30}>
                <MaterialIcons
                  name="event-available"
                  size={20}
                  color={COLORS.greenM}
                />
                <Text style={styles.textHoy}>Asistencia</Text>
              </View>
              <View style={styles.estadistica2} width={112} height={30}>
                <MsIcon
                  icon={msPersonRaisedHand}
                  size={20}
                  color={COLORS.greenM}
                />
                <Text style={styles.textHoy}>Votaciones</Text>
              </View>
              <View style={styles.estadistica2} width={104} height={30}>
                <MsIcon icon={msCloudUpload} size={20} color={COLORS.greenM} />
                <Text style={styles.textHoy}>Proyectos</Text>
              </View>
            </View>
          </View>
